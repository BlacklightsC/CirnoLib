...
namespace CirnoLib.MPQ.CompressLib
{
    public static class PKWARE
    {
		...
		private sealed class Node
		{
			...
			{
				get { return childIndex == 0 ? Child0 : Child1; }
				set
				{
					if (childIndex == 0) Child0 = value;
					else Child1 = value;
				}
			}
		}
		...
		public static byte[] DecompressBlock(byte[] inBuffer, int index, int count, byte[] outBuffer)
		{
			bool ascii;

			byte b = inBuffer[index++];
			...
			try
			{
				for (int i = 0; i < outBuffer.Length && !bitBuffer.Eof;)
				{
